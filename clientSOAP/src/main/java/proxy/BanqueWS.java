 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://imad.fa/", wsdlLocation = "http://127.0.0.1:9000/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://imad.fa/", "BanqueWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:9000/?wsdl");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://imad.fa/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://imad.fa/", "BanqueServicePort"), BanqueService.class, features);
    }
