...
public class ObjectFactory {
    ...
    private static final QName _Convert_QNAME = new QName("http://imad.fa/", "Convert");
    private static final QName _ConvertResponse_QNAME = new QName("http://imad.fa/", "ConvertResponse");
    private static final QName _GetCompte_QNAME = new QName("http://imad.fa/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://imad.fa/", "getCompteResponse");
    private static final QName _ListCompte_QNAME = new QName("http://imad.fa/", "listCompte");
    private static final QName _ListCompteResponse_QNAME = new QName("http://imad.fa/", "listCompteResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://imad.fa/", name = "Convert")
     ...
     */
    @XmlElementDecl(namespace = "http://imad.fa/", name = "ConvertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://imad.fa/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://imad.fa/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://imad.fa/", name = "listCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://imad.fa/", name = "listCompteResponse")
